<?php
    ...
    if(array_key_exists("submit", $_POST)){
        ...
        } else{ // Login with given email and password
...
<html>
	...
	<body>
        ...
        <div class="container text-center" id="dataContainer">
            ...
            <form method="post" id="login" class="userData">
                ...
                <div class="mb-3 form-check">
                    <button type="submit" class="changeButton" id="loginButton">Don't have an account? Sign up now</button>
                </div>
            </form>
